...
def  db():
    ...
    print (CarPart,PartQuantity,UnitPrice,PartToal)
    print( CarPart1,PartQuantity1,UnitPrice1,PartToal1)
    print (CarPart2,PartQuantity2,UnitPrice2,PartToal2)
    print( CarPart3,PartQuantity3,UnitPrice3,PartToal3)
